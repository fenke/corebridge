...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'corebridge.aicorebridge': { 'corebridge.aicorebridge.AICoreModule': ( 'aicorebridge.html#aicoremodule',
            ...
            'corebridge.timeseriesdatarame': { 'corebridge.timeseriesdatarame.pop_nan_values': ( 'timeseriesdataframe.html#pop_nan_values',
                                                                                                 'corebridge/timeseriesdatarame.py'),
                                               'corebridge.timeseriesdatarame.set_time_index_zone': ( 'timeseriesdataframe.html#set_time_index_zone',
                                                                                                      'corebridge/timeseriesdatarame.py'),
                                               'corebridge.timeseriesdatarame.timeseries_dataframe': ( 'timeseriesdataframe.html#timeseries_dataframe',
                                                                                                       'corebridge/timeseriesdatarame.py'),
                                               'corebridge.timeseriesdatarame.timeseries_dataframe_from_datadict': ( 'timeseriesdataframe.html#timeseries_dataframe_from_datadict',
                                                                                                                     'corebridge/timeseriesdatarame.py'),
                                               'corebridge.timeseriesdatarame.timeseries_dataframe_resample': ( 'timeseriesdataframe.html#timeseries_dataframe_resample',
                                                                                                                'corebridge/timeseriesdatarame.py'),
                                               'corebridge.timeseriesdatarame.timeseries_dataframe_to_datadict': ( 'timeseriesdataframe.html#timeseries_dataframe_to_datadict',
                                                                                                                   'corebridge/timeseriesdatarame.py')}}}
